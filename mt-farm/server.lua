...
local ItemList = {
    ...
    ["farm_batatas"] =  Config.PotatoPrice,
    ["farm_pepino"] =  Config.CucumberPrice,
    ["farm_cebola"] =  Config.OnionPrice,
    ["farm_cove"] =  Config.CabbagePrice,
    ["farm_alface"] =  Config.LettucePrice,
    ["farm_cenora"] =  Config.CarrotPrice,
    ["farm_beterraba"] =  Config.BeetPrice,
    ["farm_nabo"] =  Config.TurnipPrice,
    ["farm_cogumelos"] =  Config.MushroomsPrice,
